...
function BreadcrumbList({ className, ...props }: React.ComponentProps<"ol">) {
  return (
    <ol
      ...
      className={cn(
        "flex flex-wrap items-center gap-1.5 text-sm leading-none wrap-break-word text-muted-foreground",
        className
      )}
      {...props}
    />
...
function BreadcrumbLink({
  ...
  return (
    <Comp
      ...
      className={cn("leading-none transition-colors hover:text-foreground", className)}
      {...props}
    />
  )
}
